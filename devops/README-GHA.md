...
2. Go to your repository at [lcpgeop/tremt](https://github.com/lcpgeop/tremt).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `tremt-lcpgeop.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | tremt-lcpgeop.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | tremt-lcpgeop.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/lcpgeop/tremt/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/lcpgeop/tremt/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/lcpgeop/tremt-backend`) and Frontend (`ghcr.io/lcpgeop/tremt-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of tremt-lcpgeop.tangrama.com.br](https://github.com/lcpgeop/tremt/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/tremt-lcpgeop.tangrama.com.br.yml` stack.
